...
__published:	// IDE-managed Components
	...
	TButton *ButtonGenerisiPrave;
	TRadioButton *RadioDodajPravu;
	TButton *ButtonKonveksniOmotacPravih;
	...
	void __fastcall ButtonGenerisiPraveClick(TObject *Sender);
	void __fastcall ButtonKonveksniOmotacPravihClick(TObject *Sender);
